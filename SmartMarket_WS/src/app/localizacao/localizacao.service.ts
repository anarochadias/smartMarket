...
export class LocalizacaoService {
  ...
  constructor(private httpClient: HttpClient) { 
    this.apiUrl = environment.apiUrl + "Localizacao";
  }
  ...
  updateLocalizacao(id: string, localizacaoBody: any): Observable<Localizacao>{
    return this.httpClient.put<Localizacao>(this.apiUrl + "/" + id, localizacaoBody); //return an observable
  }

  deleteLocalizacao(id: string): Observable<Localizacao>{
    return this.httpClient.delete<Localizacao>(this.apiUrl + "/" + id); //return an observable
  }

  getLocalizacao(id: string): Observable<Localizacao>{
    return this.httpClient.get<Localizacao>(this.apiUrl + "/" + id + "/GetLocalizacao"); //return an observable
  }
